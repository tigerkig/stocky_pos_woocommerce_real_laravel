...
export default {
    ...
    This_Product_Is_Child: 'Produk ini adalah anak',
    ...
    Please_Wait_for_the_update :'CATATAN: Harap Tunggu hingga pembaruan selesai sepenuhnya. Tidak disarankan untuk menutup browser atau menghentikan proses Upgrade',
    Note_update :'Catatan: Pastikan Anda membuat cadangan versi & basis data Anda saat ini sebelum menjalankan Peningkatan, Untuk memulihkannya jika ada kesalahan',
