...
export default {
    ...
    This_Product_Is_Child: 'Este producto es niño',
    ...
    Please_Wait_for_the_update :'NOTA: Espere a que la actualización finalice por completo. No se recomienda cerrar el navegador o detener un proceso Actualizar',
