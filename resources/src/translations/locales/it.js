...
export default {
    ...
    This_Product_Is_Child: 'Questo prodotto è bambino',
    ...
    Please_Wait_for_the_update :'NOTA: attendere il completamento dell\'aggiornamento. Non è consigliabile chiudere il browser o interrompere un processo di aggiornamento',
    Note_update :'Nota: assicurati di eseguire il backup della versione corrente e del database prima di eseguire l\'aggiornamento, per ripristinarlo in caso di errore',
