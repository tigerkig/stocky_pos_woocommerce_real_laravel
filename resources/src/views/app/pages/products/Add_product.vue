              ...
              <b-row>
                ...
                <b-col md="12" class="mb-2">
                 ...
                 <!-- Multiple Variants -->
                  ...
                  <!-- This_Product_Is_Child -->
                  <b-col md="12 mb-2">
                    <ValidationProvider rules vid="product" v-slot="x">
                      <div class="form-check">
                        <label class="checkbox checkbox-outline-primary">
                          <input type="checkbox" v-model="product.is_child">
                          <h5>{{$t('This_Product_Is_Child')}}</h5>
                          <span class="checkmark"></span>
                        </label>
                      </div>
                    </ValidationProvider>
                  ...
                  <b-col md="12 mb-5" v-show="product.is_child">
                    <validation-provider
                      name="Code Product"
                    >
                      <b-form-group slot-scope="{ valid, errors }" :label="$t('CodeProduct') + ' ' + '*'">
